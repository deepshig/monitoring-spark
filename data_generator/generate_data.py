...
#         possible_values = attributeValues[attribute_name]
#         value_index = rd.randint(0, (len(possible_values) - 1))
#         value = possible_values[value_index]
#
#         conditions[attribute_name] = value
#
#     return conditions


# def generate_query():
#     query = ("""INSERT INTO voting_records (class_name, handicapped_infants, water_project_cost_sharing,
...
#             crime, duty_free_exports, export_administration_act_south_africa) VALUES (""")
#
#     condtions = get_random_conditions()
#
#     i = 0
#     for name in condtions:
#         query = query + "'" + condtions[name] + "'"
#
...
#with open generate_query()



file_location = open("/Users/vinayakprasad/Desktop/congressional-voting-records/house-votes-84.csv", "r")
